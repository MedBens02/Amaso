...
/**
 * An alternative main dashboard, kept alongside the original so the two can
 * be compared before either is retired.
 *
 * Three things it does differently:
 *
 * 1. It asks the database for figures instead of counting rows in the
 *    browser. The original issues around twenty requests - six months of
 *    incomes and expenses at per_page=1000 each, plus a request per counter -
 *    and sums them client-side. This one makes five small calls, of which
 *    /reports/annual alone replaces about fifteen of them.
 * 2. It leads with what needs doing. Drafts waiting for approval and families
 *    short of their sponsorship target are things somebody can act on today;
 *    a count of orphans is not.
 * 3. It works in dark mode. The original hard-codes bg-white and
 *    text-gray-900, so half of it disappears when the theme is switched.
 */
